export PJDIR := /root/D-Modem/pjproject-2.15.1
...
export prefix := /root/D-Modem/pjproject-2.15.1/../pjsip.install
...
export PJ_INSTALL_DIR := /root/D-Modem/pjproject-2.15.1/../pjsip.install
...
export PJ_INSTALL_LDFLAGS_PRIVATE := $(APP_THIRD_PARTY_LIBS) $(APP_THIRD_PARTY_EXT) -lm -lrt -lpthread 
