# probeselect Branch And Flow Map

- Symbol: probeselect
- Start: 0x00060d20
- End: 0x0006253c
- Size: 0x0000181d bytes

## Summary

- Conditional branches: 152
- Unconditional jumps: 76
- Direct calls: 61
- Core role: Select probing strategy/rates using large decision state machine.

## Control Regions

| Block | Entry | Role |
|---|---:|---|
| B0_ENTRY | 0x00060d20 | Entry and guard setup. |
| B1_ACTION | 0x00060d20 | Main method behavior. |
