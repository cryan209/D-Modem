# V32FP_recreate Target Walkthrough

- Function: V32FP_recreate
- Symbol: V32FP_recreate
- Range: 0x0007e870 .. 0x0007f704
- Disassembly: [V32FP_recreate_disasm.asm](/root/D-Modem/doc/V32FP_recreate_disasm.asm)
- Pseudo-C: [V32FP_recreate_pseudoc.c](/root/D-Modem/doc/V32FP_recreate_pseudoc.c)

## Purpose

Recreate/reset V.32 front-end processing state.
...
|---|---:|---|
| B0_ENTRY | 0x0007e870 | Entry and local state setup. |
| B1_ACTION | 0x0007e870 | Main helper/state-machine behavior. |
