# V90ConnectionEvaluator_evaluateConnection Branch And Flow Map

- Symbol: V90ConnectionEvaluator_evaluateConnection
- Start: 0x0003e6d0
- End: 0x0003f5e0
- Size: 0x00000f11 bytes

## Summary

- Conditional branches: 72
...
| Block | Entry | Role |
|---|---:|---|
| B0_ENTRY | 0x0003e6d0 | Entry and guard setup. |
| B1_ACTION | 0x0003e6d0 | Main method behavior. |
