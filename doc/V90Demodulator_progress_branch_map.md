# V90Demodulator_progress Branch And Flow Map

- Symbol: V90Demodulator_progress
- Start: 0x0001ca90
- End: 0x0001e6fb
- Size: 0x00001c6c bytes

## Summary

- Conditional branches: 127
- Unconditional jumps: 92
- Direct calls: 126
- Core role: Main demodulator progress engine across phase-3/phase-4/data states.

## Control Regions

| Block | Entry | Role |
|---|---:|---|
| B0_ENTRY | 0x0001ca90 | Entry and guard setup. |
| B1_ACTION | 0x0001ca90 | Main method behavior. |
