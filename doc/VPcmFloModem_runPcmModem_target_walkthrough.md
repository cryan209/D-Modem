# VPcmFloModem_runPcmModem Target Walkthrough

- Function: VPcmFloModem_runPcmModem
- Symbol: VPcmFloModem::runPcmModem(float*, float*, unsigned int, int*, int*, int*, int*)
- Range: 0x0000e430 .. 0x0000ec28
- Disassembly: [VPcmFloModem_runPcmModem_disasm.asm](/root/D-Modem/doc/VPcmFloModem_runPcmModem_disasm.asm)
- Pseudo-C: [VPcmFloModem_runPcmModem_pseudoc.c](/root/D-Modem/doc/VPcmFloModem_runPcmModem_pseudoc.c)

## Purpose

Core high-level PCM modem run loop across active phases.
