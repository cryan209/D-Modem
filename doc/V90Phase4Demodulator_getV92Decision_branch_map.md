# V90Phase4Demodulator_getV92Decision Branch And Flow Map

- Symbol: V90Phase4Demodulator_getV92Decision
- Start: 0x00026ac0
- End: 0x00027773
- Size: 0x00000cb4 bytes

## Summary

- Conditional branches: 44
- Unconditional jumps: 30
- Direct calls: 58
- Core role: Main phase-4 V.92 decision state machine over received symbols.

## Control Regions

| Block | Entry | Role |
|---|---:|---|
| B0_ENTRY | 0x00026ac0 | Entry and guard setup. |
| B1_ACTION | 0x00026ac0 | Main method behavior. |
