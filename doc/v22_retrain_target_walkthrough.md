# v22_retrain Target Walkthrough

- Function: v22_retrain
- Symbol: v22_retrain
- Range: 0x000892c0 .. 0x00089bab
- Disassembly: [v22_retrain_disasm.asm](/root/D-Modem/doc/v22_retrain_disasm.asm)
- Pseudo-C: [v22_retrain_pseudoc.c](/root/D-Modem/doc/v22_retrain_pseudoc.c)

## Purpose

Execute V.22 retrain transition/state logic.
...
|---|---:|---|
| B0_ENTRY | 0x000892c0 | Entry and local state setup. |
| B1_ACTION | 0x000892c0 | Main helper/state-machine behavior. |
