# V32OrgNextState Target Walkthrough

- Function: V32OrgNextState
- Symbol: V32OrgNextState
- Range: 0x00082be0 .. 0x000835f3
- Disassembly: [V32OrgNextState_disasm.asm](/root/D-Modem/doc/V32OrgNextState_disasm.asm)
- Pseudo-C: [V32OrgNextState_pseudoc.c](/root/D-Modem/doc/V32OrgNextState_pseudoc.c)

## Purpose

Compute next-state transitions for V.32 originate mode.
...
|---|---:|---|
| B0_ENTRY | 0x00082be0 | Entry and local state setup. |
| B1_ACTION | 0x00082be0 | Main helper/state-machine behavior. |
