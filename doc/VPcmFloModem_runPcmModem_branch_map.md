# VPcmFloModem_runPcmModem Branch And Flow Map

- Symbol: VPcmFloModem_runPcmModem
- Start: 0x0000e430
- End: 0x0000ec28
- Size: 0x000007f9 bytes

## Summary

- Conditional branches: 26
- Unconditional jumps: 42
- Direct calls: 45
- Core role: Core high-level PCM modem run loop across active phases.

## Control Regions

| Block | Entry | Role |
|---|---:|---|
| B0_ENTRY | 0x0000e430 | Entry and guard setup. |
| B1_ACTION | 0x0000e430 | Main method behavior. |
