# V32AnsNextState Target Walkthrough

- Function: V32AnsNextState
- Symbol: V32AnsNextState
- Range: 0x00085ab0 .. 0x0008649a
- Disassembly: [V32AnsNextState_disasm.asm](/root/D-Modem/doc/V32AnsNextState_disasm.asm)
- Pseudo-C: [V32AnsNextState_pseudoc.c](/root/D-Modem/doc/V32AnsNextState_pseudoc.c)

## Purpose

Compute next-state transitions for V.32 answer mode.
...
|---|---:|---|
| B0_ENTRY | 0x00085ab0 | Entry and local state setup. |
| B1_ACTION | 0x00085ab0 | Main helper/state-machine behavior. |
