# V90Equalizer_convertEqualizerToMmx Target Walkthrough

- Function: V90Equalizer_convertEqualizerToMmx
- Range: 0x00037330 .. 0x00037d3c
- Disassembly: [V90Equalizer_convertEqualizerToMmx_disasm.asm](/root/D-Modem/doc/V90Equalizer_convertEqualizerToMmx_disasm.asm)
- Pseudo-C: [V90Equalizer_convertEqualizerToMmx_pseudoc.c](/root/D-Modem/doc/V90Equalizer_convertEqualizerToMmx_pseudoc.c)
...
~~~c
void V90Equalizer_convertEqualizerToMmx_pseudoc(void *self)
~~~
...
|---|---:|---|
| B0_ENTRY | 0x00037330 | Entry and local state setup. |
| B1_ACTION | 0x00037330 | Main helper/state-machine behavior. |
| B2_RETURN | 0x00037d3c | Return tail. |
