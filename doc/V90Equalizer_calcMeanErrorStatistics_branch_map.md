# V90Equalizer_calcMeanErrorStatistics Branch And Flow Map

- Symbol: V90Equalizer_calcMeanErrorStatistics
- Start: 0x000388c0
- End: 0x00038d76
- Size: 0x000004b7 bytes
...
| Block | Entry | Role |
|---|---:|---|
| B0_ENTRY | 0x000388c0 | Entry and guard setup. |
| B1_ACTION | 0x000388c0 | Main method behavior. |
