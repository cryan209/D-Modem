# V90Phase4Demodulator_reset Branch And Flow Map

- Symbol: V90Phase4Demodulator_reset
- Start: 0x000277c0
- End: 0x000279b7
...
- Direct calls: 11
- Core role: Reset phase-4 demodulator runtime state for new phase/session.
