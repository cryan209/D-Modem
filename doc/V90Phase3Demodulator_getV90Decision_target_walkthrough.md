# V90Phase3Demodulator_getV90Decision Target Walkthrough

- Function: V90Phase3Demodulator_getV90Decision
- Range: 0x00023830 .. 0x000258ea
- Disassembly: [V90Phase3Demodulator_getV90Decision_disasm.asm](/root/D-Modem/doc/V90Phase3Demodulator_getV90Decision_disasm.asm)
- Pseudo-C: [V90Phase3Demodulator_getV90Decision_pseudoc.c](/root/D-Modem/doc/V90Phase3Demodulator_getV90Decision_pseudoc.c)

## Purpose

Main V.90 decision engine for phase-3 symbol processing and state-machine transitions.
...
|---|---:|---|
| B0_ENTRY | 0x00023830 | Method entry and setup path. |
| B1_ACTION | 0x00023830 | Main algorithm/transition behavior. |
| B2_RETURN | 0x000258ea | Return path. |
